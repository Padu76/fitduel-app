...
export async function POST(request: NextRequest) {
  try {
    ...
    // Step 5: Prepare data using REAL database columns (excluding generated columns)
    const calibrationRecord = {
      ...
      // Fitness level (numeric only, fitness_category is auto-generated)
      fitness_level: 1, // Numeric level 1-5
      // fitness_category: REMOVED - this is auto-generated by database
      
      // Calibration status - try multiple safe values
      calibration_status: 'incomplete', // Try 'incomplete' if 'pending' fails
      calibration_step: 1,
